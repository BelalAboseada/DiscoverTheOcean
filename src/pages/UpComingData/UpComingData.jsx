const UpComingData = () => {
  return (
    <div className="UpComingData bg-blue-dark  px-4 py-8 ">
      <p className="text-lg md:text-xl lg:text-2xl font-normal md:font-medium text-light leading-10">
      ...
      <ul className="list-disc text-light my-2 mx-4 text-base font-light">
        ...
        <li className="underline underline-offset-1">
          <a
            target="_blank"
            href="https://www.nasa.gov/specials/ocean-worlds/"
          >
            NASA: Ocean worlds
          </a>
        </li>
